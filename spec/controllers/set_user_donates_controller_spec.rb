  ...
  describe "POST #create" do
    context "with valid attributes" do
      it "create new user club" do
        expect do
          post :create, xhr: true, params: {club_id: club, event_id: event,
            email: user.email, expense: 100_000}
    ...
    context "when params not present" do
      before do
        ...
        params: {club_id: club, event_id: event, email: user.email, expense: nil}
      end
